...
const jsonData = {
  ...
  user: {
    ...
    updatedAt: '2024-04-04T19:42:36.179Z',
    __v: 73,
    refreshToken:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWIzYTIyYzAxZDkwMGU5NmM0MjE5YWUiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3MTIyNTk3NTYsImV4cCI6MTcyMDAzNTc1Nn0.M5TYzeQJdrprynC_Xq_Ymf-NAu9YZXeu6t8_wvjtgbc',
  },
}

type TData = typeof jsonData

type TUserData = Omit<TData, 'success'>

type TService = (typeof jsonData.user.services)[0]
